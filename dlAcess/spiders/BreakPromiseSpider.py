...
from dlAcess.items import BreakPromiseItem, ItemList


class BreakPromiseSpider(scrapy.Spider):
    name = 'break_promise'

    start_urls = ["https://credit.dl.cn/credit-portal/dl/publicity/record/break_promise"]

    list_url = "https://credit.dl.cn/credit-portal/dl/api/publicity/record/SXBZXR/0"
