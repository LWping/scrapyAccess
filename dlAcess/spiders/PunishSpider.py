...
from dlAcess.items import PunishItem, ItemList


class PunishSpider(scrapy.Spider):
    name = 'punish'

    start_urls = ["https://credit.dl.cn/credit-portal/dl/publicity/record/punish_publicity"]

    list_url = "https://credit.dl.cn/credit-portal/dl/api/publicity/record/PUNISH/0"
