...
from dlAcess.items import ItemList, AbnormalItem


class AbnormalSpider(scrapy.Spider):
    name = 'abnormal'

    start_urls = ["https://credit.dl.cn/credit-portal/dl/publicity/record/abnormal"]

    list_url = "https://credit.dl.cn/credit-portal/dl/api/publicity/record/JYYCML/0"
        ...
        if self.page_num == 1:
            ...
            try:
                ...
                for resource in resources:
                    item_list['administra_counterpart_name'] = resource['xdrMc']
                    item_list['unicode'] = resource['xdrShxym']
    ...
    def parse_nav_detail(self, response):
        ...
        for event in events:
            ...
            if len(event_detail) % 20 == 0:
                ...
                item['administra_counterpart_code3'] = event_detail[3]
                item['administra_counterpart_code2'] = event_detail[4]
                item['administra_counterpart_code4'] = event_detail[5]
                item['institution_cert_no'] = event_detail[6]
                item['social_organ_register_cert_no'] = event_detail[7]
                item['legal_person'] = event_detail[8]
                item['legal_person_cert_type'] = event_detail[9]
                item['legal_person_cert'] = event_detail[10]
                item['list_decision_doc_no'] = event_detail[11]
                item['list_reason'] = event_detail[12]
                item['list_date'] = event_detail[13]
                item['remove_decision_doc_no'] = event_detail[14]
                item['remove_reason'] = event_detail[15]
                item['remove_date'] = event_detail[16]
                item['list_authority'] = event_detail[17]
                item['remove_authority'] = event_detail[18]
                item['source'] = event_detail[19]
                yield item
                event_detail.clear()
